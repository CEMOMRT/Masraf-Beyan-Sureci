...
namespace stj1_masraf_beyan_sureci.Report
{
	[EnableCors]
    [DontWrapResultFilter]
    [ApiExplorerSettings(IgnoreApi = true)]
	[Route("apps/stj1_masraf_beyan_sureci/latest/api/ReportViewer")]
	[Route("api/ReportViewer")]
	[Route("apps/stj1_masraf_beyan_sureci/{v:int:min(1)}/api/ReportViewer")]
