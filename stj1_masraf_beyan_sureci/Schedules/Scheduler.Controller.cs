...
namespace stj1_masraf_beyan_sureci.Schedulers.Controller
{
    [Route("apps/stj1_masraf_beyan_sureci/latest/api/Scheduler/[action]")]
    [Route("apps/stj1_masraf_beyan_sureci/{v:int:min(1)}/api/Scheduler/[action]")]
