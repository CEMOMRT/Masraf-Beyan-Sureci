...
namespace stj1_masraf_beyan_sureci.Forms {
    ...
    public partial class Form1 : Form<E_stj1_masraf_beyan_sureci_Form1Entity> {
...
DataGrid masrafBeyanTablo { get; set; }
TextBox TextBox2 { get; set; }
UserMetadata pozisyonBilgi { get; set; }
Image Image2 { get; set; }
NumberBox toplamMasraf { get; set; }
UserMetadata adSoyad { get; set; }
...
ControlId = "cb3ef616-c8b2-e2f8-88cc-9716c077d900",
...
Text = new MultiLanguageText(new Dictionary<string, string> {{ "tr-TR", "Fişler" },}){
EnableMultiLanguageText = true,
UserCulture = "",
DefaultCulture = "",
},
...
Id = 0,
CategoryId = "fda3c16a-6c97-f6a2-ec35-48fa9fb1dc3e",
...
Viewable = true,
CreateEnabled = false,
Path = "Stajer Projeleri/stj_comurtag",
...
AddToViewItems("default", default_relateddocuments1Component);

Header1 = new Header {
ControlId = "8f6fdecb-eea2-ee88-c65b-b94fe688099c",
Name = "Header1",
ServerEvents = new List<EventItem> {
},
ClientEvents = new List<EventItem> {
...
Title = new MultiLanguageText(new Dictionary<string, string> {{ "tr-TR", "Header1" },}){
EnableMultiLanguageText = true,
UserCulture = "",
DefaultCulture = "",
},
...
Family = "Source Sans Pro, sans-serif",
Size = "25",
Color = "rgb(121, 173, 229)",
Bold = true,
Italic = false,
Underline = false,
Strikethrough = false
},
Text = new MultiLanguageText(new Dictionary<string, string> {{ "tr-TR", "MASRAF BEYAN SÜRECİ" },{ "en-US", "Header1" },}){
EnableMultiLanguageText = true,
UserCulture = "",
DefaultCulture = "",
},
...
ControlId = "f7d68748-aaf6-5706-66c8-de77b3320efe",
...
Caption = new ControlCaption {
Text = new MultiLanguageText(new Dictionary<string, string> {{ "tr-TR", "Döküman ID" },}){
EnableMultiLanguageText = true,
UserCulture = "",
DefaultCulture = "",
},
...
AddToViewItems("default", default_documentmetadata1Component);

DocumentMetadata2 = new DocumentMetadata {
ControlId = "9d3756d5-fff0-03f4-e49e-710c67f308f9",
...
AddToViewItems("default", default_documentmetadata2Component);
...
masrafBeyanTablo = new DataGrid {
ControlId = "a81a02fc-5401-985a-f8a8-86092224ff1d",
Name = "masrafBeyanTablo",
ServerEvents = new List<EventItem> {
},
ClientEvents = new List<EventItem> {
new EventItem {
Name = "OnSummaryChanged",
MethodName = "masrafBeyanTablo_OnSummaryChanged",
Async = null
},
},
Visible = true,
...
EntityPath = "E_stj1_masraf_beyan_sureci_Form1_masrafBeyanTablo",
ReadOnly = false,
DefaultReadOnly = false,
Indexable = false,
...
EditType = ColumnEditType.ComboBox,
EditingEnabled = true,
ShowEditorAlways = false,
Filtering = new DataGridColumnFilteringOptions {
Enabled = false,
...
Controls.Add(masrafBeyanTablo);

BaseComponent default_masrafbeyantabloComponent = new BaseComponent {
Id = "masrafBeyanTablo",
Type = "DataGrid",
ParentId = "Column3",
DesignerProps = new DesignerProps {
...
Properties = masrafBeyanTablo,
ViewProperties = "",
};

AddToViewItems("default", default_masrafbeyantabloComponent);
...
Name = "Form1";
FormId = "ae2cfebd-aa88-41e1-a437-e1152c88a57e";
...
IdentityFormat = "DocumentNum";
IdentityFormatId = 124;
...
ControlId = "9975d07b-6465-fca6-4982-c769143adc73",
Name = "TextBox2",
ServerEvents = new List<EventItem> {
},
ClientEvents = new List<EventItem> {
...
Caption = new ControlCaption {
Text = new MultiLanguageText(new Dictionary<string, string> {{ "tr-TR", "Ödeme Yapacak IBAN" },}){
EnableMultiLanguageText = true,
UserCulture = "",
DefaultCulture = "",
},
...
BaseComponent default_textbox2Component = new BaseComponent {
Id = "TextBox2",
Type = "TextBox",
ParentId = "Column3",
DesignerProps = new DesignerProps {
...
AddToViewItems("default", default_textbox2Component);

pozisyonBilgi = new UserMetadata {
ControlId = "e6792dab-2505-108c-3e4e-55faea8853e3",
Name = "pozisyonBilgi",
ServerEvents = new List<EventItem> {
},
ClientEvents = new List<EventItem> {
...
Controls.Add(pozisyonBilgi);

BaseComponent default_pozisyonbilgiComponent = new BaseComponent {
Id = "pozisyonBilgi",
Type = "UserMetadata",
ParentId = "Column4",
DesignerProps = new DesignerProps {
...
Properties = pozisyonBilgi,
ViewProperties = "",
};

AddToViewItems("default", default_pozisyonbilgiComponent);

Image2 = new Image {
ControlId = "14ba1364-3926-1f21-cbe6-1bccb2516281",
Name = "Image2",
ServerEvents = new List<EventItem> {
},
ClientEvents = new List<EventItem> {
...
toplamMasraf = new NumberBox {
ControlId = "5b27d06e-aa9b-116e-74dc-6b0a63819f7b",
Name = "toplamMasraf",
ServerEvents = new List<EventItem> {
},
ClientEvents = new List<EventItem> {
...
Caption = new ControlCaption {
Text = new MultiLanguageText(new Dictionary<string, string> {{ "tr-TR", "TOPLAM MASRAF" },}){
EnableMultiLanguageText = true,
UserCulture = "",
DefaultCulture = "",
},
...
Controls.Add(toplamMasraf);

BaseComponent default_toplammasrafComponent = new BaseComponent {
Id = "toplamMasraf",
Type = "NumberBox",
ParentId = "Column3",
DesignerProps = new DesignerProps {
...
Properties = toplamMasraf,
ViewProperties = "",
};

AddToViewItems("default", default_toplammasrafComponent);
...
adSoyad = new UserMetadata {
ControlId = "93526017-5b0c-a7c8-7cb4-23690093744e",
Name = "adSoyad",
ServerEvents = new List<EventItem> {
},
ClientEvents = new List<EventItem> {
...
Label1 = new Label {
ControlId = "b70829ce-d5bd-7af9-0d0d-aadf2a1dd3e5",
Name = "Label1",
ServerEvents = new List<EventItem> {
},
ClientEvents = new List<EventItem> {
...
Text = new MultiLanguageText(new Dictionary<string, string> {{ "tr-TR", "HESAP BEYANLARI" },{ "en-US", "Label1" },}){
EnableMultiLanguageText = true,
UserCulture = "",
DefaultCulture = "",
},
...
Label2 = new Label {
ControlId = "20478553-f83d-7e9e-8d41-92aaa2abfdaf",
Name = "Label2",
ServerEvents = new List<EventItem> {
},
ClientEvents = new List<EventItem> {
...
Family = "Source Sans Pro, sans-serif",
Size = "17",
Color = "rgba(245, 166, 35, 0.89)",
Bold = true,
Italic = false,
Underline = false,
Strikethrough = false
},
Text = new MultiLanguageText(new Dictionary<string, string> {{ "tr-TR", "Toplam tutar sistem tarafından belirlenen tutardan daha yüksek gelmiştir.Değerlendirilmesi için yöneticinize yönlendirilecektir." },{ "en-US", "Label2" },}){
EnableMultiLanguageText = true,
UserCulture = "",
DefaultCulture = "",
},
