...
namespace stj1_masraf_beyan_sureci.Forms {
    ...
    public partial class Masraf_harcama : Form<E_stj1_masraf_beyan_sureci_Masraf_harcamaEntity> {

        // properties
        ComboBox masrafTip { get; set; }
TextArea masrafAciklama { get; set; }
Divider Divider1 { get; set; }
NumberBox kisiMaksOdeme { get; set; }
Divider Divider2 { get; set; }
NumberBox odencekTutar { get; set; }
NumberBox NBkisiSayisi { get; set; }
DateTimePicker masrafTarihi { get; set; }
NumberBox masrafTutari { get; set; }


        // constructor
        public Masraf_harcama(FormHttpParameters httpParameters, ITelemetryCollectorHolder telemetryCollectorHolder = null)
...
masrafTip = new ComboBox {
ControlId = "c7eaf495-7c64-8323-ae38-502ba206aee0",
Name = "masrafTip",
...
new EventItem {
Name = "OnValueChanged",
MethodName = "masrafTip_OnValueChanged",
Async = null
},
},
Visible = true,
...
Name = "tipiSorgu",
ValueMember = "IDmasraf",
DisplayMember = new List<string>{
"tipMasraf",
},
DisplayFormat = "{{ tipMasraf }}",
Culture = "",
CultureMember = "",
MultiLanguagePath = "",
RunAtServer = false,
...
Controls.Add(masrafTip);
masrafTip.Items = new ListItemCollection();

BaseComponent default_masraftipComponent = new BaseComponent {
Id = "masrafTip",
Type = "ComboBox",
ParentId = "Column1",
...
Properties = masrafTip,
ViewProperties = "",
};

AddToViewItems("default", default_masraftipComponent);
...
{ "tr-TR", "Masraf_harcama" },
{ "en-US", "Masraf_harcama" },
{ "ru-RU", "Masraf_harcama" },
{ "az-Latn-AZ", "Masraf_harcama" },
};
Name = "Masraf_harcama";
FormId = "5a821be5-6e0a-4605-af15-232772e0124c";
...
Caption = new ControlCaption {
Text = new MultiLanguageText(new Dictionary<string, string> {{ "tr-TR", "Masraf_harcama" },{ "en-US", "Masraf_harcama" },{ "ru-RU", "Masraf_harcama" },{ "az-Latn-AZ", "Masraf_harcama" },}){
EnableMultiLanguageText = true,
UserCulture = "",
DefaultCulture = "",
},
...
BaseComponent default_masraf_harcamaComponent = new BaseComponent {
Id = "Masraf_harcama",
Type = "Form",
ParentId = "",
DesignerProps = new DesignerProps {
...
AddToViewItems("default", default_masraf_harcamaComponent);

masrafAciklama = new TextArea {
ControlId = "31c876fb-061f-2c75-441d-aee74f90be1b",
Name = "masrafAciklama",
ServerEvents = new List<EventItem> {
},
ClientEvents = new List<EventItem> {
...
Caption = new ControlCaption {
Text = new MultiLanguageText(new Dictionary<string, string> {{ "tr-TR", "Masraf Açıklaması" },}){
EnableMultiLanguageText = true,
UserCulture = "",
DefaultCulture = "",
},
...
Controls.Add(masrafAciklama);

BaseComponent default_masrafaciklamaComponent = new BaseComponent {
Id = "masrafAciklama",
Type = "TextArea",
ParentId = "Column3",
DesignerProps = new DesignerProps {
...
Properties = masrafAciklama,
ViewProperties = "",
};

AddToViewItems("default", default_masrafaciklamaComponent);

BaseComponent default_section1Component = new BaseComponent {
Id = "Section1",
Type = "Section",
ParentId = "Masraf_harcama",
DesignerProps = new DesignerProps {
AllowAutoClear = true,
Layout = new ContainerLayout {
Width = null,
...
ControlId = "1e0480dd-3a14-ad9d-fd14-5db23faa2ff1",
Name = "Divider1",
ServerEvents = new List<EventItem> {
},
ClientEvents = new List<EventItem> {
...
kisiMaksOdeme = new NumberBox {
ControlId = "df09fff2-d60b-a64a-8310-5d14f3869b4d",
Name = "kisiMaksOdeme",
ServerEvents = new List<EventItem> {
},
ClientEvents = new List<EventItem> {
new EventItem {
Name = "OnValueChanged",
MethodName = "kisiMaksOdeme_OnValueChanged",
Async = null
},
},
Visible = true,
...
Caption = new ControlCaption {
Text = new MultiLanguageText(new Dictionary<string, string> {{ "tr-TR", "Kişi başı maksimum ödeme" },}){
EnableMultiLanguageText = true,
UserCulture = "",
DefaultCulture = "",
},
...
Controls.Add(kisiMaksOdeme);

BaseComponent default_kisimaksodemeComponent = new BaseComponent {
Id = "kisiMaksOdeme",
Type = "NumberBox",
ParentId = "Column1",
DesignerProps = new DesignerProps {
...
Properties = kisiMaksOdeme,
ViewProperties = "",
};

AddToViewItems("default", default_kisimaksodemeComponent);

Divider2 = new Divider {
ControlId = "1600bb52-fa50-9f45-9011-e0f80efe8cc9",
Name = "Divider2",
ServerEvents = new List<EventItem> {
},
ClientEvents = new List<EventItem> {
...
ControlId = "ce2fe275-5016-fe20-4608-0bb0f25843c8",
Name = "odencekTutar",
ServerEvents = new List<EventItem> {
},
ClientEvents = new List<EventItem> {
new EventItem {
Name = "OnValueChanged",
MethodName = "odencekTutar_OnValueChanged",
Async = null
},
},
Visible = true,
...
NBkisiSayisi = new NumberBox {
ControlId = "71ba1ea3-1682-1c90-fbd7-5139a8f64e8b",
Name = "NBkisiSayisi",
ServerEvents = new List<EventItem> {
},
ClientEvents = new List<EventItem> {
new EventItem {
Name = "OnValueChanged",
MethodName = "NBkisiSayisi_OnValueChanged",
Async = null
},
},
Visible = true,
...
Controls.Add(NBkisiSayisi);

BaseComponent default_nbkisisayisiComponent = new BaseComponent {
Id = "NBkisiSayisi",
Type = "NumberBox",
ParentId = "Column1",
DesignerProps = new DesignerProps {
...
Properties = NBkisiSayisi,
ViewProperties = "",
};

AddToViewItems("default", default_nbkisisayisiComponent);
...
masrafTarihi = new DateTimePicker {
ControlId = "8d22c9af-756a-1d09-440f-c378bc393d1a",
Name = "masrafTarihi",
ServerEvents = new List<EventItem> {
},
ClientEvents = new List<EventItem> {
...
Caption = new ControlCaption {
Text = new MultiLanguageText(new Dictionary<string, string> {{ "tr-TR", "Masraf Tarihi" },}){
EnableMultiLanguageText = true,
UserCulture = "",
DefaultCulture = "",
},
...
Controls.Add(masrafTarihi);

BaseComponent default_masraftarihiComponent = new BaseComponent {
Id = "masrafTarihi",
Type = "DateTimePicker",
ParentId = "Column3",
DesignerProps = new DesignerProps {
...
Properties = masrafTarihi,
ViewProperties = "",
};

AddToViewItems("default", default_masraftarihiComponent);
...
ControlId = "3fafc700-b64b-2e35-5345-6bb59e72d4f6",
Name = "masrafTutari",
ServerEvents = new List<EventItem> {
},
ClientEvents = new List<EventItem> {
new EventItem {
Name = "OnValueChanged",
MethodName = "masrafTutari_OnValueChanged",
Async = null
},
},
Visible = true,
